...
class PrayTimes():
    ...
    methods = {
        ...
        'Diyanet': {
            ...
            'params': { 'fajr': 18, 'isha': 17 },
            'offsets': { 'fajr': 45, 'sunrise': -6, 'dhuhr': 5, 'asr': 3, 'maghrib': 5, 'isha': -49 } },
        'Indonesia': {
            'name': 'KEMENAG',
            'params': { 'fajr': 20, 'isha': 18 },
            'offsets': { 'fajr': 2, 'sunrise': -2, 'dhuhr': 3, 'asr': 3, 'maghrib': 2, 'isha': 2 } },
        'ISNA': {
    ...
    def __init__(self, method = "Diyanet") :
...
if __name__ == "__main__":
    ...
    prayTimes.tune( {'dhuhr': 7, 'asr':4, 'maghrib': 7, 'fajr': 0, 'sunrise': -6,'isha': -5} )
    #prayTimes.adjust({'highLats':'OneSeventh'})
    times=prayTimes.getTimes(today, (52.52,13.41), 1, is_dst(today,timeZone), '24h')
